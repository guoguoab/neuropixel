...
def resolve_input_path(input_path):
    ...
    raise FileNotFoundError(
        f"Cannot find file: {input_path}. Tried: {candidate_paths}"
    )
...
channels_csv_path = resolve_input_path(args.channels_csv)
units_csv_path = resolve_input_path(args.units_csv)

unit_points, matched_units, region_channel_ids = load_units_from_region(
    channels_csv=channels_csv_path,
    units_csv=units_csv_path,
